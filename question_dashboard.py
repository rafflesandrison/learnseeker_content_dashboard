...
with open('math_new.txt', 'r', encoding='utf-8') as math_questions:
    ...
    for question in questions:
        ...
        #print(data_breakdown[question_type]["Primary 1"])

        mcqs = data_breakdown[question_type]
        # mcq_primary_1_topics = mcqs["Primary 1"]["topics"]
        
        # Incrementing count
        if (level == "Primary 1" or level == "Primary 2"):
...
# print(p1_whole_numbers_easy_uuids)

# print("\nP1 Whole Numbers Normal")
# print(p1_whole_numbers_normal_uuids)
